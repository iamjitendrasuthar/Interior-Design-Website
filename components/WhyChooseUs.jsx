...
//         <motion.div
//           variants={fadeInUp}
//           className="bg-gray-50 rounded-3xl p-8 md:col-span-2 flex flex-col justify-between overflow-hidden relative group"
//         >
...
//           <div className="mt-8 h-32 relative flex items-center">
...
//               />
//               <div className="absolute top-1/2 left-[70%] -translate-y-1/2 -translate-x-1/2 w-8 h-8 bg-white border-2 border-[#132A13] rounded-full flex items-center justify-center shadow-md">
//                 <div className="w-3 h-3 bg-[#132A13] rounded-full"></div>
//               </div>
//             </div>
//           </div>
//         </motion.div>
...
//         <motion.div
//           variants={fadeInUp}
//           className="bg-gray-50 rounded-3xl p-8 flex flex-col items-center justify-center text-center"
//         >
...
//             />
//           </div>
//           <h3 className="text-2xl font-semibold mb-2">Timeless Aesthetics</h3>
//         </motion.div>

//         {/* Card 3 */}
//         <motion.div
//           variants={fadeInUp}
//           className="bg-gray-50 rounded-3xl p-8 flex flex-col justify-center text-center"
//         >
//           <h3 className="text-3xl font-semibold mb-2">Award Winning</h3>
//           <p className="text-gray-600">
//             Premium quality materials and exclusive designs.
//           </p>
//         </motion.div>
...
//         <motion.div
//           variants={fadeInUp}
//           className="bg-gray-50 rounded-3xl p-8 md:col-span-2 flex flex-col md:flex-row items-center justify-between gap-8"
//         >
//           <div>
//             <h3 className="text-4xl font-semibold mb-2 flex items-center gap-4">
//               Expert{" "}
//               <img
...
//             </h3>
//             <p className="text-gray-600">
//               Guaranteed on-time delivery and flawless execution.
//             </p>
//           </div>
//           <div className="text-6xl font-bold text-[#132A13]">50+</div>
//         </motion.div>
//       </motion.div>
//     </section>
//   );
